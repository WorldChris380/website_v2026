...
export const routes: Routes = [
    ...
    { path: 'photography', loadComponent: () => import('./gallery/gallery').then(m => m.Gallery) },
    { path: 'gallery', redirectTo: 'photography', pathMatch: 'full' },
    ...
    { path: 'shop/pricing', loadComponent: () => import('./shop/shop-home').then(m => m.ShopHome) },
