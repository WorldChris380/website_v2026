...
export class ShopCartPage implements OnInit {
    ...
    t(key: string): string {
        ...
        const map: Record<string, string> = {
            ...
            summary: de ? 'Bestelluebersicht' : 'Order Summary',
            ...
            commercialPerItem: de ? 'Kommerzielle Nutzung fuer dieses Bild' : 'Commercial usage for this image',
            digitalDelivery: de ? 'Digitale Lizenz. Download und Rechnung sind direkt nach der Zahlung verfuegbar.' : 'Digital license. Download and invoice are available immediately after payment.',
            owner: de ? 'Zertifikatsinhaber' : 'Certificate holder',
            ownerHint: de ? 'Der Zertifikatsname wird automatisch aus deinem Konto uebernommen.' : 'The certificate holder is taken directly from your account.',
            logout: de ? 'Abmelden' : 'Logout',
            loginRequired: de ? 'Bitte melde dich an, damit der Zertifikatsname automatisch uebernommen wird.' : 'Please sign in so the certificate holder can be filled in automatically.',
            ...
            emptyLead: de ? 'Fuege zuerst Fotos aus der Galerie hinzu.' : 'Add photos from the gallery to get started.',
            ...
            stepTwo: de ? 'Lizenz bestaetigen' : 'Confirm license',
            stepTwoCopy: de ? 'Pro Bild die kommerzielle Nutzung aktivieren. Versand faellt komplett weg.' : 'Enable commercial usage per image. Shipping is removed entirely.',
            ...
            checkoutReady: de ? 'Bereit fuer den Checkout' : 'Ready for checkout',
            checkoutReadyCopy: de ? 'Dein Zertifikatsname ist uebernommen. Du kannst direkt mit PayPal abschliessen.' : 'Your certificate name is set. You can complete checkout directly with PayPal.',
