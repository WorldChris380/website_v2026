...
export class LanguageService {
    ...
    private translations: Record<Language, Record<string, string>> = {
        en: {
            ...
            'menuDescTravelStories': 'Travel stories and experiences',
            'menuDescTravelGallery': 'Photo gallery from my travels',
        ...
        de: {
            ...
            'menuDescTravelStories': 'Reiseberichte und Erlebnisse',
            'menuDescTravelGallery': 'Fotogalerie meiner Reisen',
