...
<div class="summary-page">
    ...
    <div *ngIf="!countryCode" class="summary-error">
    ...
    <ng-container *ngIf="countryCode">
        <div class="summary-hero" [class.photo-loading]="!photoUrl">
            <img *ngIf="photoUrl" [src]="photoUrl" [alt]="countryName" class="summary-hero-img">
            <div class="summary-hero-overlay">
                <div class="summary-hero-inner">
                    <div class="summary-flag-wrap" aria-hidden="true">
                        <img *ngIf="getFlagUrl()" [src]="getFlagUrl()" [alt]="''" width="36" height="26"
                            loading="eager">
                    </div>
        ...
        <div class="summary-body">
            ...
            <section class="summary-breakdown-section" *ngIf="grandTotal">
                ...
                <div class="summary-breakdown-row" *ngIf="activities">
                    <span>{{ lang === 'de' ? 'Aktivit&auml;ten' : 'Activities' }}</span>
                    <span>{{ fmt(activities) }}</span>
                </div>
                <div class="summary-breakdown-row" *ngIf="flightAmt">
